...
TOOLBOXES["llama-rocm-7.2.2"]="docker.io/kyuz0/amd-r9700-toolboxes:rocm-7.2.2 --device /dev/dri --device /dev/kfd --group-add video --group-add render --group-add sudo --security-opt seccomp=unconfined"
