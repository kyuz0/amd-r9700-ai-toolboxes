...
TOOLBOXES["llama-rocm-7.2.3"]="docker.io/kyuz0/amd-r9700-toolboxes:rocm-7.2.3 --device /dev/dri --device /dev/kfd --group-add video --group-add render --group-add sudo --security-opt seccomp=unconfined"
TOOLBOXES["llama-rocm7-nightlies"]="docker.io/kyuz0/amd-r9700-toolboxes:rocm7-nightlies --device /dev/dri --device /dev/kfd --group-add video --group-add render --group-add sudo --security-opt seccomp=unconfined"

# MTP (Multi-Token Prediction) — am17an/llama.cpp mtp-clean branch
TOOLBOXES["llama-vulkan-radv-mtp"]="docker.io/kyuz0/amd-r9700-toolboxes:vulkan-radv-mtp --device /dev/dri --group-add video --security-opt seccomp=unconfined"
TOOLBOXES["llama-rocm-7.2.3-mtp"]="docker.io/kyuz0/amd-r9700-toolboxes:rocm-7.2.3-mtp --device /dev/dri --device /dev/kfd --group-add video --group-add render --group-add sudo --security-opt seccomp=unconfined"
