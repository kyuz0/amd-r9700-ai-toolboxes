...
toolbox create llama-rocm-7.2.2 \
  --image docker.io/kyuz0/amd-r9700-toolboxes:rocm-7.2.2 \
...
# or: toolbox enter llama-rocm-7.2.2
```
...
```bash
distrobox create -n llama-rocm-7.2.2 \
  --image docker.io/kyuz0/amd-r9700-toolboxes:rocm-7.2.2 \
  --additional-flags "--device /dev/kfd --device /dev/dri --group-add video --group-add render --security-opt seccomp=unconfined"
distrobox enter llama-rocm-7.2.2
```
...
./refresh-toolboxes.sh llama-vulkan-radv llama-rocm-7.2.2
```
